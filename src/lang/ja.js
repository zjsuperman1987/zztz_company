export default {
  ...
  home: {
    ...
    personal: '私の口座',
    myNotice: '私からのお知らせ',
    favorites: 'コレクション [{fav}]',
    quickNavigation: 'ショートカットナビゲータ',
    classNavigation: '分類ナビゲータ',
    pubGoods: '商品をリリースする',
    pubAD: '広告を出す',
    pubFB: 'フィードバック',
    recharge: 'チャージ',
    ...
    message: 'メッセージ',
    refresh: '刷新する',
    noMoreGoods: 'これ以上の商品はない!!!',
    showMoreGoods: 'もっと見る>',
    footer: 'このサービスは、私たちが提供または提案する以外のいかなる方法でも利用してはいけません。また、このサービスはいかなる違法または非合法的な方法で使用されないことを保証します。または、いかなる違法または合法的な活動をサポートする目的で使用されます。このウェブサイトにログインし、このサービスを登録すると、あなたが承諾し、またあなたが所属する司法管轄区の法律に基づいて合法的にこのサービスを受けることができる人であることを保証します。',
  },
}
