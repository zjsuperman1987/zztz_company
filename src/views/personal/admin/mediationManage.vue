    ...
    <div style="width: 100%">
        ...
        <div class="buyer">
            ...
            <el-table :data="buyerTableData" v-loading="buyerLoading" highlight-current-row border
                ...
                <el-table-column label="交易编号" prop="rid" width="60" align="center"></el-table-column>
                <el-table-column label="申请人" width="50" align="center">
                    <template v-slot="{row}">
                        <el-button type="text" @click="userClick(row.uid)">{{ row.uid }}</el-button>
                    </template>
                </el-table-column>
                <el-table-column label="申请调解时间" prop="cretime" width="110" align="center"></el-table-column>
                <el-table-column label="调解费" prop="medfee" width="80" align="center"></el-table-column>
                <el-table-column label="所属分类" prop="goods.ea_title" width="75" align="center"></el-table-column>
                <el-table-column label="商品名称" show-overflow-tooltip>
                    <template v-slot="{row}">
                        <router-link @click.native="inTO(row)" to="">{{ row.goods.title }}</router-link>
                    </template>
                </el-table-column>
                <el-table-column label="卖家" width="50" align="center">
                    <template v-slot="{row}">
                        <el-button type="text" @click="userClick(row.order.seller)">{{ row.order.seller }}</el-button>
                    </template>
                </el-table-column>
                <el-table-column label="交易金额(BTC)" prop="order.amount" width="90"></el-table-column>
                <el-table-column label="付款时间" prop="order.cretime" width="110" align="center"></el-table-column>
        ...
        <div class="seller">
            ...
            <el-table :data="sellerTableData" v-loading="sellerLoading" highlight-current-row border
                ...
                <el-table-column label="申请调解时间" prop="cretime" width="110" align="center"></el-table-column>
                <el-table-column label="调解费" prop="medfee" width="80"></el-table-column>
                <el-table-column label="所属分类" prop="goods.ea_title" width="75" align="center"></el-table-column>
                <el-table-column label="商品名称" show-overflow-tooltip>
                    <template v-slot="{row}">
                        <router-link @click.native="inTO(row)" to="">{{ row.goods.title }}</router-link>
                ...
                <el-table-column label="买家" width="50" align="center">
                    <template v-slot="{row}">
                        <el-button type="text" @click="userClick(row.order.buyer)">{{ row.order.buyer }}</el-button>
                    </template>
                </el-table-column>
                <el-table-column label="交易金额(BTC)" prop="order.amount" width="90"></el-table-column>
                <el-table-column label="付款时间" prop="order.cretime" width="110" align="center"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getBuyerSuspendList() {
                ...
                this.$http.get('/AdmMediate', {params}).then(res => {
                    if (res) {
