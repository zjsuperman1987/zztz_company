<template>
    <div class="edit-goods">
        ...
        <ubb-textarea v-model="content" path="goods" ref="textarea" :title="$t('goodsDetails.after_sale_message')"
            ...
            getInfo() {
                this.$http.get('/WebMyGoods/read', {params: {id: this.id}}).then(res => {
                    if (res) {
                        ...
                        this.historyList = res.after_sales_history
                        this.content = res.after_sales ? res.after_sales.contents : ''
                    }
                })
            },
